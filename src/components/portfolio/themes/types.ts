...
export const THEME_OPTIONS = [
  ...
  { value: 'graphic-designer-pro', label: 'Graphic Designer Pro', description: 'Magazine-style editorial theme with 3D elements', isPremium: true, price: 300 },
  { value: 'graphic-designer-elite', label: 'Graphic Designer Elite', description: 'Luxury dark theme with cinematic animations', isPremium: true, price: 400 },
  ...
  { value: 'web-developer-pro', label: 'Web Developer Pro', description: 'Matrix-style dark theme with terminal aesthetics', isPremium: true, price: 300 },
  { value: 'web-developer-elite', label: 'Web Developer Elite', description: 'Glassmorphism cyberpunk theme with 3D elements', isPremium: true, price: 400 },
