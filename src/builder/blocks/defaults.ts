  ...
  /* ============== ECOMMERCE ============== */
  {
    ...
    create: () => ({
      ...
      content: {
        ...
        subtitle: "Hand-picked picks from our latest collection",
        columns: 4,
        accentColor: "#0f172a",
        items: [
          {
            ...
            hoverImage: "https://images.unsplash.com/photo-1581655353564-df123a1eb820?w=600",
            badge: "Sale",
            rating: 5,
            inStock: true,
          },
      ...
      style: { background: "#fafafa", paddingTop: "0px", paddingBottom: "0px" },
    }),
  },
  {
    type: "productCard",
